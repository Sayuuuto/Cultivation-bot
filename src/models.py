...
class Player(Base):
    ...
    story_step: Mapped[str] = mapped_column(String(64), default="")
    story_message_id: Mapped[str | None] = mapped_column(String(32), nullable=True)
...
class PlayerGearItem(Base):
    ...
    stat_hp: Mapped[int] = mapped_column(Integer, default=0)
    ...
    gear_rarity: Mapped[str] = mapped_column(String(16), default="common")
