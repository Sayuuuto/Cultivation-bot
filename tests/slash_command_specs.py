...
SLASH_COMMAND_SPECS: list[SlashCommandSpec] = [
    ...
    SlashCommandSpec("gather", kwargs={"area": "bamboo_grove"}),
    SlashCommandSpec("hunt", kwargs={"area": "bamboo_grove"}, validate_view=True),
    SlashCommandSpec(
        "adventure",
        kwargs={
            "area": "bamboo_grove",
    ...
    SlashCommandSpec("equip-technique", kwargs={"setup": "basic_strike|1"}),
    SlashCommandSpec("learn", kwargs={"manual": "manual_ember_palm"}, forbidden_in_text=("already know",)),
    ...
    SlashCommandSpec("equip", kwargs={"slot": "weapon"}),
    SlashCommandSpec("item", kwargs={"name": "qi_gathering_pill"}),
    SlashCommandSpec("technique", kwargs={"name": "ember_palm"}),
    ...
    SlashCommandSpec(
        "reset",
        kwargs={"confirm": False, "dao_name": "ResetDao", "origin": _origin_choice()},
    ),
    SlashCommandSpec(
        "start",
